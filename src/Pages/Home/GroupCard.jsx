...
const GroupCard = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="bg-gray-500 mx-[8%] xl:w-[1390px]  max-lg:mx-0 flex justify-center rounded-xl max-lg:py-[3em] mt-[150px] py-[4em]  max-lg:pr-[5%] max-md:mx-0 max-md:w-[500px] lg:w-[1000px] max-sm:w-[90%] ">
        <div className="flex xl:gap-[1.6em] max-md:grid-cols-1 max-xl:grid max-xl:grid-cols-2 lg:gap-[2em] lg:gap-x-[1em] max-lg:gap-[3em] max-lg:mx-[6%] lg:mx-0 mx-[8%] max-sm:mx-0 rounded-lg justify-center items-center">
          {groupData.map((item, index) => {
            return (
              ...
              >
                <p className="text-[4.5em] leading-[1.2] mt-[9px]">
                  {item.icon}
                </p>
                <p className="raleway font-semibold text-[1.5em] max-lg:mx-[6%] leading-[1.2]">
                  {item.title}
                </p>
                <p className="raleway text-[2.5em] leading-[1] mt-[-3px] font-semibold">
                  {item.num}
                </p>
              </div>
            );
